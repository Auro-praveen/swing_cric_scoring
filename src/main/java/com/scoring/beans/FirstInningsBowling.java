...
@Entity
@Table(name = "first_innings_bowling")
public class FirstInningsBowling implements Serializable{
    
    @Id
    @GeneratedValue(strategy = GenerationType.AUTO)
    private long first_innings_bowling_id;
    private short bowler_jersey_no;
    private short overs_bowled;
    @Column(length = 50)
    ...
    public FirstInningsBowling() {
        
    }

    public FirstInningsBowling(long first_innings_bowling_id, short bowler_jersey_no, short overs_bowled, String bowler_name, String bowler_full_name, short maiden_overs, short wickets_taken, String nameof_wicket_taken_batsmens, String bowled_at, short runs_given, short extras_given, short noof_wides, short noof_noballs, short noof_byes, double economy, MatchDetails matchDetails, TeamBean teamBean) {
        this.first_innings_bowling_id = first_innings_bowling_id;
    ...
    public void setFirst_innings_bowling_id(long first_innings_bowling_id) {
        this.first_innings_bowling_id = first_innings_bowling_id;
    }
    ...
    public void setOvers_bowled(short overs_bowled) {
        this.overs_bowled = overs_bowled;
    }
    ...
    public long getFirst_innings_bowling_id() {
        return first_innings_bowling_id;
    }
