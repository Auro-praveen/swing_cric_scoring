 ...
 */
@Entity
@Table(name = "first_innings_batting")
public class FirstInningsBatting implements Serializable {

    @Id
    @GeneratedValue(strategy = GenerationType.AUTO)
    private long first_innings_batting_id;
    @Column(length = 50)
    ...
    public void setFirst_innings_batting_id(long first_innings_batting_id) {
        this.first_innings_batting_id = first_innings_batting_id;
    }
    ...
    public long getFirst_innings_batting_id() {
        return first_innings_batting_id;
    }
